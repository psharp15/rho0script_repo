...
TREENAME=ghe_pippimprotinc__F4_B4_T2_S4_Tree
DSELECTOR=/work/halld2/home/psharp/rho0script_repo/DSelectors/1p_DS/DS_1p_0cuts.C
NTHREADS=32

INPUTFILE=/volatile/halld/home/psharp/simulation/halld_sim_swif/AV18_He4/0bg/root/trees/tree_ghe_pippimprotinc__F4_B4_T2_S4_gen_gcf_090091_*.root
    
root -q -b 'Run_Selector.C("'${INPUTFILE}'","'${TREENAME}'","'${DSELECTOR}'",'${NTHREADS}')'

mv output.root /work/halld2/home/psharp/simulation/output/geant_gcf/0cuts_study/flattree_He4_1p_inc_AV18.root
