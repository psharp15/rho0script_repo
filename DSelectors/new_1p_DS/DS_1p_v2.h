...
class DS_1p_v2 : public DSelector {
public:
  DS_1p_v2(TTree *locTree = NULL) : DSelector(locTree) {}
  virtual ~DS_1p_v2() {}
...
void DS_1p_v2::Get_ComboWrappers(void) {
  // Step 0
  ...
  dProtonWrapper = static_cast<DChargedTrackHypothesis *>(
