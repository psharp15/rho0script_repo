#ifndef DS_1p_0cuts_h
#define DS_1p_0cuts_h
...
class DS_1p_0cuts : public DSelector
{
	public:

		DS_1p_0cuts(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DS_1p_0cuts(){}
	...
	ClassDef(DS_1p_0cuts, 0);
};

void DS_1p_0cuts::Get_ComboWrappers(void)
{
	//Step 0
