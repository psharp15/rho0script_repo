#include "DS_1p_1track.h"

void DS_1p_1track::Init(TTree *locTree)
{
...
//	dFlatTreeFileName = "flattree_gd__prot_AV18_inc_0bg_1track.root";
    	dFlatTreeFileName = "flattree_ghe__prot_AV18_inc_0bg_1track.root";
    	//dFlatTreeFileName = "flattree_gc12__prot_AV18_inc_0bg_1track.root";
//	dFlatTreeFileName = "flattree_gc12__prot_N2LO_inc_0bg_1track.root";	
	//dFlatTreeFileName = "flattree_gc12__prot_AV4_inc_0bg_1track.root";
...
/****** DATA Flattrees ***********/
	...
	//false/true below: use measured/kinfit data
        ...
        dAnalysisActions.push_back(new DCutAction_NumUnusedTracks(dComboWrapper, 1, ""));
            //CUT: 0 unused tracks
...
Bool_t DS_1p_1track::Process(Long64_t locEntry)
{
	//CALL THIS FIRST
...
void DS_1p_1track::Finalize(void)
{
	//CALL THIS LAST
