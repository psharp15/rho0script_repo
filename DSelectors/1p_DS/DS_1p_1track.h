...
class DS_1p_1track : public DSelector
{
	public:

		DS_1p_1track(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DS_1p_1track(){}
	...
	ClassDef(DS_1p_1track, 0);
};

void DS_1p_1track::Get_ComboWrappers(void)
{
	//Step 0
