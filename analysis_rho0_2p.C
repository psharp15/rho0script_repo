...
void analysis_rho0_2p(const char *inputfilename, const char *outfilename)
{
  cerr << "Hello world\n";


  TFile *inputFile = new TFile(inputfilename);
  TTree *inputTree = (TTree*) inputFile-> Get("gc12_pippimprotprotinc__F4_B4");


  TFile *fout=new TFile(outfilename,"RECREATE");
  TTree *outputTree = new TTree("C12_2p_inc_cut",  "C12_2p_inc_cut");
